...
//  uint32_t frameUniOffset = m_vkWindow->currentFrame() * vbOffset;// _material->vertUniSize;
//  uint32_t frameUniOffsets[] = { frameUniOffset };
//  m_deviceFuncs->vkCmdBindDescriptorSets(
//    _cmdBuffer,
//    VK_PIPELINE_BIND_POINT_GRAPHICS,
//    _material->pipelineLayout,
//    0, _material->descSets.size(),
//    &_material->descSets[0],
//    1,
//    frameUniOffsets
//  );
//
...
//  uint32_t frameUniOffset = m_vkWindow->currentFrame() * vbOffset; //(
////    _material->vertUniSize +
////    _material->fragUniSize
////  );
...
//    _material->pipelineLayout,
//    0, _material->descSets.size(),
//    &_material->descSets[0], // Dynamic UBOs
//    2,
//    frameUniOffsets
//  );
//
...
//    _material->pipelineLayout,
//    0, _material->descSets.size(),
//    &_material->descSets[0], // Texture Sampler
//    0,
//    nullptr
//  );
//
