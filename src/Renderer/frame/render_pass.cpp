...
void Renderer::cmdRenderPass()
{
  ...
  renderPassBeginInfo.renderPass = m_actorMaterial->renderPass;

  renderPassBeginInfo.framebuffer = m_pipelineHelper.getFramebuffer(extentWidth, extentHeight);//m_vkWindow->currentFramebuffer();
